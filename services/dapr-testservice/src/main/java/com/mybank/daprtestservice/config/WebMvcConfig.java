package com.mybank.daprtestservice.config;

import com.mybank.daprtestservice.controller.DaprController;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void configurePathMatch(PathMatchConfigurer configurer) {
        configurer.addPathPrefix(restApiBasePath,
                HandlerTypePredicate.forBasePackage(DaprController.class.getPackageName())
