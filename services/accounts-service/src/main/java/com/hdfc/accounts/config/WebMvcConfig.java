package com.hdfc.accounts.config;

import com.hdfc.accounts.controller.AccountEntityController;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void configurePathMatch(PathMatchConfigurer configurer) {
        configurer.addPathPrefix(restApiBasePath,
                HandlerTypePredicate.forBasePackage(AccountEntityController.class.getPackageName())
