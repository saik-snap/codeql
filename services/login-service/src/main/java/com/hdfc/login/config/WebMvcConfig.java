package com.hdfc.login.config;

import com.hdfc.login.controller.LoginEntityController;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void configurePathMatch(PathMatchConfigurer configurer) {
        configurer.addPathPrefix(restApiBasePath,
                HandlerTypePredicate.forBasePackage(LoginEntityController.class.getPackageName())
