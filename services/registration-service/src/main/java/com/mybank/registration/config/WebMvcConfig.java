package com.mybank.registration.config;

import com.mybank.registration.controller.RegistrationEntityController;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void configurePathMatch(PathMatchConfigurer configurer) {
        configurer.addPathPrefix(restApiBasePath,
                HandlerTypePredicate.forBasePackage(RegistrationEntityController.class.getPackageName())
