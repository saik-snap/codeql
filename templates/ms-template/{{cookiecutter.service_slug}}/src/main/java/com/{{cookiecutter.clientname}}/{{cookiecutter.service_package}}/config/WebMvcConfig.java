package com.{{cookiecutter.clientname}}.{{cookiecutter.service_package}}.config;

import com.{{cookiecutter.clientname}}.{{cookiecutter.service_package}}.controller.{{cookiecutter.entity}}Controller;
